...
public class MyPageDAO {
	 ...
	 * @param item_transaction_id 直近で購入した商品のid
	 * @param user_master_id ユーザーID
	 * @return 直近で購入した商品と同じ商品の購入履歴を格納したDTOのリスト
	 */
	public ArrayList<MyPageDTO> getMyPageUserInfo(
		...
		try{
			...
			/* 取得した情報を1行ごとに別々のDTOインスタンスに格納する。 */
			/* DTOインスタンスはmyPageDTOリストに格納する。 */
